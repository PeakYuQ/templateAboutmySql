...
public class emNoteController {
    ...
    public Integer sendMail(
        ...
        message message = new message("note",txt,0,title,timestamp,(String)session.getAttribute("operator"));
